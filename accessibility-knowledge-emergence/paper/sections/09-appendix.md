...
Correct: The purpose of alt text is to provide a textual description of an image for people with visual disabilities.

Incorrect: The purpose of alt text is to make images load faster.

**Skip Link**

Correct: A skip link is a navigation aid that allows keyboard users to bypass repetitive content.
...
- **Functional Socratic:   
**A screen reader is software that reads text aloud. Why would it fail to describe `<img src='photo.jpg'>`?  
